...
public class CompilationTest {
    ...
    private static final JavaFileObject source1 = JavaFileObjects.forSourceLines(// format one per line
    "test.Source1", "package test;", "", "class Source1 {}");

    private static final JavaFileObject source2 = JavaFileObjects.forSourceLines(// format one per line
    "test.Source2", "package test;", "", "interface Source2 {}");

    private static final JavaFileObject brokenSource = JavaFileObjects.forSourceLines(// format one per line
    "test.BrokenSource", "package test;", "", "interface BrokenSource { what is this }");
    ...
    @Test
    public void describeFailureDiagnostics_includesWarnings_whenCompilingWerror_1() {
        // Arrange
        Compiler compiler = javac().withOptions("-Xlint:cast", "-Werror");
        JavaFileObject source = JavaFileObjects.forSourceLines(// 
        "test.CastWarning", // 
