...
public final class CompilerTest {
    ...
    private File compileTestLib() throws IOException {
        ...
        StandardJavaFileManager fileManager = compiler.getStandardFileManager(/* diagnosticListener= */
        null, Locale.getDefault(), UTF_8);
        ...
        null, ImmutableList.of(JavaFileObjects.forSourceLines("Lib", "class Lib {}")));
    ...
    public void options() {
        ...
        Compilation unused = javac().withOptions(options1).withOptions(ImmutableList.of("-Ab=2", "-Ac=3")).withProcessors(processor).compile(files);
        assertThat(processor.options).containsExactly("b", "2", "c", "3").inOrder();
    }
    ...
    @Test
    public void multipleProcesors_1() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
    ...
    @Test
    public void multipleProcesors_2() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_3() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_4() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_5() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_asIterable_1() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_asIterable_2() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_asIterable_3() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_asIterable_4() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    @Test
    public void multipleProcesors_asIterable_5() {
        NoOpProcessor noopProcessor1 = new NoOpProcessor();
        NoOpProcessor noopProcessor2 = new NoOpProcessor();
        NoOpProcessor noopProcessor3 = new NoOpProcessor();
        /*[Transform from] assertThat(noopProcessor1.invoked).isFalse();[NONE Params]*/
    ...
    public void classPath_default() {
        Compilation compilation = javac().compile(JavaFileObjects.forSourceLines("Test", "import com.google.testing.compile.CompilerTest;", "class Test {", "  CompilerTest t;", "}"));
        assertThat(compilation).succeeded();
    }

    @Test
    public void classPath_empty() {
        Compilation compilation = javac().withClasspath(ImmutableList.of()).compile(JavaFileObjects.forSourceLines("Test", "import com.google.testing.compile.CompilerTest;", "class Test {", "  CompilerTest t;", "}"));
    ...
    public void classPath_customFiles() throws Exception {
        ...
        Compilation compilation = javac().withClasspath(ImmutableList.of(lib)).withOptions("-verbose").compile(JavaFileObjects.forSourceLines(// 
        "Test", "class Test {", "  Lib lib;", "}"));
        assertThat(compilation).succeeded();
    }

    @Test
    public void classPath_empty_urlClassLoader() {
        Compilation compilation = javac().withClasspathFrom(new URLClassLoader(new URL[0], Compiler.platformClassLoader)).compile(JavaFileObjects.forSourceLines("Test", "import com.google.testing.compile.CompilerTest;", "class Test {", "  CompilerTest t;", "}"));
        assertThat(compilation).hadErrorContaining("com.google.testing.compile does not exist");
    }
    ...
    public void classPath_customFiles_urlClassLoader() throws Exception {
        File lib = compileTestLib();
        Compilation compilation = javac().withClasspathFrom(new URLClassLoader(new URL[] { lib.toURI().toURL() })).withOptions("-verbose").compile(JavaFileObjects.forSourceLines("Test", "class Test {", "  Lib lib;", "}"));
        assertThat(compilation).succeeded();
    }
    ...
    public void releaseFlag() {
        ...
        Compilation compilation = javac().withOptions("--release", "8").compile(JavaFileObjects.forSourceString("HelloWorld", "final class HelloWorld {}"));
        assertThat(compilation).succeeded();
    }
}
