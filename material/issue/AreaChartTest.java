...
public class AreaChartTest {
     ...
     */
    @Test
    public void testReplaceDataset_1() {
        Number[][] data = new Integer[][] { { -30, -20 }, { -10, 10 }, { 20, 30 } };
        CategoryDataset newData = DatasetUtils.createCategoryDataset("S", "C", data);
        LocalListener l = new LocalListener();
        this.chart.addChangeListener(l);
        CategoryPlot plot = (CategoryPlot) this.chart.getPlot();
        plot.setDataset(newData);
        /*[Transform from] assertEquals(true, l.flag);[NONE Params]*/
        ;
     ...
     */
    @Test
    public void testReplaceDataset_2() {
        Number[][] data = new Integer[][] { { -30, -20 }, { -10, 10 }, { 20, 30 } };
        CategoryDataset newData = DatasetUtils.createCategoryDataset("S", "C", data);
        LocalListener l = new LocalListener();
        this.chart.addChangeListener(l);
        ...
        ValueAxis axis = plot.getRangeAxis();
        Range range = axis.getRange();
        /*[Transform from] assertTrue("Expecting the lower bound of the range to be around -30: " + range.getLowerBound(), range.getLowerBound() <= -30);[NONE Params]*/
        ;
