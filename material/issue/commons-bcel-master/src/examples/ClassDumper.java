...
class ClassDumper {
    ...
    // collection of constants
    private Constant[] constant_items;
    ...
    private final void processFieldOrMethod() throws IOException, ClassFormatException {
        ...
        for (int i = 0; i < attributes_count; i++) {
            ...
            if ((pos2 - pos1) != (attribute_length + 6)) {
                System.out.printf("%nattribute_length: %d pos2-pos1-6: %d pos1: %x(%d) pos2: %x(%d)%n", attribute_length, pos2 - pos1 - 6, pos1, pos1, pos2, pos2);
            }
            System.out.printf("  ");
