...
public class ASTFunDecl extends SimpleNode implements MiniParserTreeConstants, org.apache.bcel.Constants {
    ...
    // true, if simple expression like `12 + f(a)'
    ...
    public void closeNode() {
        ...
        // May be 0-size array
        argv = new ASTIdent[children.length - 2];
    ...
    public int eval(final int pass) {
        // Maybe other function has already called us
        final int expected = name.getType();
        // And updated the env
        type = body.eval(expected);
    ...
    public void byte_code(final ClassGen class_gen, final ConstantPoolGen cp) {
        ...
        if (!ignore) {
            ...
            // First optimization pass, provided by MethodGen
            method.removeNOPs();
            // Second optimization pass, application-specific
            optimizeIFs(il);
