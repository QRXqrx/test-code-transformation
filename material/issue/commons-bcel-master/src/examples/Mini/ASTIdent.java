...
public class ASTIdent extends ASTExpr implements org.apache.bcel.Constants {
    ...
    // Reference in environment to decl of this ident
    ...
    public ASTExpr traverse(final Environment env) {
        ...
        if (entry == null) {
            ...
            MiniC.addError(line, column, "Function " + name + " used as an identifier.");
        } else {
            reference = (Variable) entry;
        }
        // Nothing to reduce/traverse further here
        return this;
    }
    ...
    public int eval(final int expected) {
        ...
        // (Very) simple expression, always true
        is_simple = true;
        if ((t == T_UNKNOWN) && (expected == T_UNKNOWN)) {
            ...
            // Caller has to check for an error, i.e. t != expected
            type = t;
        }
        return type;
    }
