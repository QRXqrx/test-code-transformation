...
public class FieldGen extends FieldGenOrMethodGen {
    ...
    public Field getField() {
        ...
        if (value != null) {
            ...
            addAttribute(new ConstantValue(super.getConstantPool().addUtf8("ConstantValue"), 2, index, // sic
            super.getConstantPool().getConstantPool()));
        }
        addAnnotationsAsAttribute(super.getConstantPool());
        return new Field(super.getAccessFlags(), name_index, signature_index, getAttributes(), // sic
        super.getConstantPool().getConstantPool());
    }
