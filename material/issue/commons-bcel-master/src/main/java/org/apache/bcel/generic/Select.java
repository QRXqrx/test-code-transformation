 ...
 * @see InstructionList
 */
public abstract class Select extends BranchInstruction implements VariableLengthInstruction, StackConsumer, /* @since 6.0 */
StackProducer {
     ...
     */
    @Deprecated
    protected int[] // matches, i.e., case 1: ... TODO could be package-protected?
    match;
     ...
     */
    @Deprecated
    protected int[] // target offsets TODO could be package-protected?
    indices;
     ...
     */
    @Deprecated
    protected InstructionHandle[] // target objects in instruction list TODO could be package-protected?
    targets;
     ...
     */
    @Deprecated
    protected int // fixed length defined by subclasses TODO could be package-protected?
    fixed_length;
     ...
     */
    @Deprecated
    protected int // number of cases TODO could be package-protected?
    match_length;
     ...
     */
    @Deprecated
    protected int // number of pad bytes for alignment TODO could be package-protected?
    padding = 0;
