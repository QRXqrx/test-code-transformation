...
final class ConstantHTML {
    ...
    private void writeConstant(final int index) {
        ...
        file.println("<H4> <A NAME=cp" + index + ">" + index + "</A> " + Const.getConstantName(tag) + "</H4>");
        ...
        switch(tag) {
            ...
            case Const.CONSTANT_Methodref:
                ...
                short_method_class = Utility.compactClassName(short_method_class, classPackage + ".", // Remove class package prefix
                true);
                ...
                constantRef[index] = ret_type + "&nbsp;<A HREF=\"" + className + "_cp.html#cp" + class_index + "\" TARGET=Constants>" + short_method_class + "</A>.<A HREF=\"" + className + "_cp.html#cp" + index + "\" TARGET=ConstantPool>" + html_method_name + "</A>&nbsp;" + arg_types;
            ...
            case Const.CONSTANT_Fieldref:
                ...
                short_field_class = Utility.compactClassName(short_field_class, classPackage + ".", // Remove class package prefix
                true);
                ...
                constantRef[index] = "<A HREF=\"" + className + "_cp.html#cp" + class_index + "\" TARGET=Constants>" + short_field_class + "</A>.<A HREF=\"" + className + "_cp.html#cp" + index + "\" TARGET=ConstantPool>" + field_name + "</A>";
            ...
            case Const.CONSTANT_Class:
                ...
                short_class_name = Utility.compactClassName(short_class_name, classPackage + ".", // Remove class package prefix
                true);
