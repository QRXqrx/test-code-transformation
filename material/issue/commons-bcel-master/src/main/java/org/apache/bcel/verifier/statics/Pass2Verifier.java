            ...
            for (final Attribute att : atts) {
                ...
                if (att instanceof SourceFile) {
                    if (!foundSourceFile) {
                        ...
                        throw new ClassConstraintException("A ClassFile structure (like '" + tostring(obj) + // vmspec2 4.7.7
                ...
                for (int a = 0; a < atts.length; a++) {
                    ...
                    if (atts[a] instanceof LocalVariableTable) {
                        ...
                        for (final LocalVariable localvariable : localvariables) {
                            ...
                            final String localsig = // Local sig.(=descriptor)
                            ((ConstantUtf8) (cp.getConstant(localvariable.getSignatureIndex()))).getBytes();
                            Type t;
                            try {
