...
public class FieldAnnotationsTestCase extends AbstractTestCase {
    ...
    public void testFieldAnnotationModification() throws ClassNotFoundException {
        ...
        // there are two fields in the class, removing
        f = clg.getFields()[1];
    ...
    // helper methods
    public void checkAnnotatedField(final JavaClass clazz, final String fieldname, final String AnnotationEntryName, final String AnnotationEntryElementName, final String AnnotationEntryElementValue) {
