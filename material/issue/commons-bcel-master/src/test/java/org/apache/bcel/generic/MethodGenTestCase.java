...
public class MethodGenTestCase {
    ...
    @Test
    public void testAnnotationsAreUnpacked_1() throws Exception {
        final JavaClass jc = Repository.lookupClass(Bar.Inner.class);
        final ClassGen cg = new ClassGen(jc);
        final MethodGen mg = new MethodGen(cg.getMethodAt(0), cg.getClassName(), cg.getConstantPool());
        final List<AnnotationEntryGen> firstParamAnnotations = mg.getAnnotationsOnParameter(0);
        /*[Transform from] Assert.assertEquals("Wrong number of annotations in the first parameter", 1, firstParamAnnotations.size());*/
    ...
    @Test
    public void testRemoveLocalVariable_1() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
    ...
    @Test
    public void testRemoveLocalVariable_2() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
        ...
        Assert.assertNotNull("scope start", start);
        Assert.assertNotNull("scope end", end);
        /*[Transform from] Assert.assertTrue("scope start not targeted by the local variable", Arrays.asList(start.getTargeters()).contains(lv));*/
    ...
    @Test
    public void testRemoveLocalVariable_3() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
        ...
        /*[Transform from] Assert.assertTrue("scope start not targeted by the local variable", Arrays.asList(start.getTargeters()).contains(lv));*/
        Arrays.asList(start.getTargeters()).contains(lv);
        /*[Transform from] Assert.assertTrue("scope end not targeted by the local variable", Arrays.asList(end.getTargeters()).contains(lv));*/
    ...
    @Test
    public void testRemoveLocalVariable_4() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
        ...
        // now let's remove the local variable
        mg.removeLocalVariable(lv);
        /*[Transform from] Assert.assertFalse("scope start still targeted by the removed variable", Arrays.asList(start.getTargeters()).contains(lv));*/
        Arrays.asList(start.getTargeters()).contains(lv);
        Assert.assertFalse("scope end still targeted by the removed variable", Arrays.asList(end.getTargeters()).contains(lv));
    }

    @Test
    public void testRemoveLocalVariable_5() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
        ...
        /*[Transform from] Assert.assertFalse("scope start still targeted by the removed variable", Arrays.asList(start.getTargeters()).contains(lv));*/
        Arrays.asList(start.getTargeters()).contains(lv);
        /*[Transform from] Assert.assertFalse("scope end still targeted by the removed variable", Arrays.asList(end.getTargeters()).contains(lv));*/
        Arrays.asList(end.getTargeters()).contains(lv);
        Assert.assertNull("scope start", lv.getStart());
    }

    @Test
    public void testRemoveLocalVariable_6() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
        ...
        /*[Transform from] Assert.assertFalse("scope end still targeted by the removed variable", Arrays.asList(end.getTargeters()).contains(lv));*/
        Arrays.asList(end.getTargeters()).contains(lv);
        /*[Transform from] Assert.assertNull("scope start", lv.getStart());*/
        lv.getStart();
    ...
    @Test
    public void testRemoveLocalVariables_1() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
    ...
    @Test
    public void testRemoveLocalVariables_2() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
    ...
    @Test
    public void testRemoveLocalVariables_3() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
    ...
    @Test
    public void testRemoveLocalVariables_4() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
    ...
    @Test
    public void testRemoveLocalVariables_5() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
    ...
    @Test
    public void testRemoveLocalVariables_6() throws Exception {
        final MethodGen mg = getMethod(Foo.class, "bar");
        final LocalVariableGen lv = mg.getLocalVariables()[1];
        /*[Transform from] Assert.assertEquals("variable name", "a", lv.getName());*/
        lv.getName();
