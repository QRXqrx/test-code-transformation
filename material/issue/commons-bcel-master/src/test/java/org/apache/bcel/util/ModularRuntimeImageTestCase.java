...
public class ModularRuntimeImageTestCase {
    ...
    @Test
    public void testListJreModules_1() throws IOException {
        final List<Path> listEntries = modularRuntimeImage.list(ModularRuntimeImage.MODULES_PATH);
        /*[Transform from] Assert.assertFalse(listEntries.isEmpty());*/
        listEntries.isEmpty();
    ...
    @Test
    public void testListJreModule_1() throws IOException {
        final List<Path> listEntries = modularRuntimeImage.list(ModularRuntimeImage.MODULES_PATH + "/java.base");
        /*[Transform from] Assert.assertFalse(listEntries.isEmpty());*/
        listEntries.isEmpty();
        Assert.assertTrue(listEntries.toString().indexOf("/java.base") > -1);
    ...
    @Test
    public void testListJreModulePackageDir_1() throws IOException {
        final List<Path> listEntries = modularRuntimeImage.list(ModularRuntimeImage.MODULES_PATH + "/java.base/java/lang");
        /*[Transform from] Assert.assertFalse(listEntries.isEmpty());*/
        listEntries.isEmpty();
    ...
    @Test
    public void testListJrePackages_1() throws IOException {
        final List<Path> listEntries = modularRuntimeImage.list(ModularRuntimeImage.PACKAGES_PATH);
        /*[Transform from] Assert.assertFalse(listEntries.isEmpty());*/
        listEntries.isEmpty();
