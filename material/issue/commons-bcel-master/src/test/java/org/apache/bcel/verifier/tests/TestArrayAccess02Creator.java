...
public class TestArrayAccess02Creator extends TestCreator {
    ...
    public TestArrayAccess02Creator() {
        _cg = new ClassGen(TEST_PACKAGE + ".TestArrayAccess02", "java.lang.Object", "TestArrayAccess02.java", Const.ACC_PUBLIC | Const.ACC_SUPER, new String[] {});
