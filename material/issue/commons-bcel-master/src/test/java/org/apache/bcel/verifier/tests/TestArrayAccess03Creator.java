...
public class TestArrayAccess03Creator extends TestCreator {
    ...
    public TestArrayAccess03Creator() {
        _cg = new ClassGen(TEST_PACKAGE + ".TestArrayAccess03", "java.lang.Object", "TestArrayAccess03.java", Const.ACC_PUBLIC | Const.ACC_SUPER, new String[] {});
