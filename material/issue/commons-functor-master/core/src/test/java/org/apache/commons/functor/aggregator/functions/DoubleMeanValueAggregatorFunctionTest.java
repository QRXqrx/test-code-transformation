...
public class DoubleMeanValueAggregatorFunctionTest extends BaseFunctorTest {
    ...
    @Test
    public void testMean_1() throws Exception {
        DoubleMeanValueAggregatorFunction fct = (DoubleMeanValueAggregatorFunction) makeFunctor();
        List<Double> lst = new ArrayList<Double>();
        lst.add(0.0);
        double res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 0.0, 0.01);[NONE Params]*/
        ;
        lst.add(1.0);
    ...
    @Test
    public void testMean_2() throws Exception {
        DoubleMeanValueAggregatorFunction fct = (DoubleMeanValueAggregatorFunction) makeFunctor();
        List<Double> lst = new ArrayList<Double>();
        lst.add(0.0);
        double res = fct.evaluate(lst);
        ...
        lst.add(1.0);
        res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 0.5, 0.01);[NONE Params]*/
        ;
        lst.add(2.0);
        res = fct.evaluate(lst);
    ...
    @Test
    public void testMean_3() throws Exception {
        DoubleMeanValueAggregatorFunction fct = (DoubleMeanValueAggregatorFunction) makeFunctor();
        List<Double> lst = new ArrayList<Double>();
        lst.add(0.0);
        double res = fct.evaluate(lst);
        ...
        lst.add(2.0);
        res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 1.0, 0.01);[NONE Params]*/
        ;
