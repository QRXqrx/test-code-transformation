...
public class DoubleMedianValueAggregatorFunctionTest extends BaseFunctorTest {
    ...
    public void testMedianNotCopy_2() throws Exception {
        ...
        lst.add(10.0);
        double res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 10.0, DELTA);[NONE Params]*/
        ;
        assertListEqualsArray(lst, new double[] { 10.0 });
        lst.add(1000.0);
        res = fct.evaluate(lst);
    ...
    public void testMedianNotCopy_3() throws Exception {
        ...
        lst.add(1000.0);
        res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 505.0, DELTA);[NONE Params]*/
        ;
        assertListEqualsArray(lst, new double[] { 10.0, 1000.0 });
        lst.add(30.0);
        res = fct.evaluate(lst);
    ...
    public void testMedianNotCopy_4() throws Exception {
        ...
        lst.add(30.0);
        res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 30.0, DELTA);[NONE Params]*/
        ;
