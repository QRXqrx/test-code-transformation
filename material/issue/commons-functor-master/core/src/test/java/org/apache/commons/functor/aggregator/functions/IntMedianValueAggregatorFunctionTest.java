...
public class IntMedianValueAggregatorFunctionTest extends BaseFunctorTest {
    ...
    void assertListEqualsArray(List<Integer> list, int[] arr) throws Exception {
        ...
        for (int i = 0; i < arr.length; i++) assertEquals(list.get(i).intValue(), arr[i]);
    }
    ...
    @Test
    public void testEmptyList_1() throws Exception {
        IntegerMedianValueAggregatorFunction fct = (IntegerMedianValueAggregatorFunction) makeFunctor();
     ...
     */
    @Test
    public void testMedianNotCopy_1() throws Exception {
        IntegerMedianValueAggregatorFunction fct = new IntegerMedianValueAggregatorFunction(false);
     ...
     */
    @Test
    public void testMedianNotCopy_2() throws Exception {
        IntegerMedianValueAggregatorFunction fct = new IntegerMedianValueAggregatorFunction(false);
        /*[Transform from] assertFalse(fct.isUseCopy());*/
        fct.isUseCopy();
        List<Integer> lst = new ArrayList<Integer>();
        lst.add(10);
        int res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 10);[NONE Params]*/
        ;
        assertListEqualsArray(lst, new int[] { 10 });
        lst.add(1000);
        res = fct.evaluate(lst);
     ...
     */
    @Test
    public void testMedianNotCopy_3() throws Exception {
        IntegerMedianValueAggregatorFunction fct = new IntegerMedianValueAggregatorFunction(false);
        /*[Transform from] assertFalse(fct.isUseCopy());*/
        fct.isUseCopy();
        List<Integer> lst = new ArrayList<Integer>();
        ...
        lst.add(1000);
        res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 505);[NONE Params]*/
        ;
        assertListEqualsArray(lst, new int[] { 10, 1000 });
        lst.add(30);
        res = fct.evaluate(lst);
     ...
     */
    @Test
    public void testMedianNotCopy_4() throws Exception {
        IntegerMedianValueAggregatorFunction fct = new IntegerMedianValueAggregatorFunction(false);
        /*[Transform from] assertFalse(fct.isUseCopy());*/
        fct.isUseCopy();
        List<Integer> lst = new ArrayList<Integer>();
        ...
        lst.add(30);
        res = fct.evaluate(lst);
        /*[Transform from] assertEquals(res, 30);[NONE Params]*/
        ;
