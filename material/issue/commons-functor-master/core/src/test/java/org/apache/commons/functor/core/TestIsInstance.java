...
public class TestIsInstance extends BaseFunctorTest {
    ...
    public void testTest_1() throws Exception {
        BinaryPredicate<Object, Class<?>> p = IsInstance.INSTANCE;
        /*[Transform from] assertFalse(p.test(null, Number.class));*/
        p.test(null, Number.class);
    ...
    public void testTest_2() throws Exception {
        ...
        /*[Transform from] assertFalse(p.test(null, Number.class));*/
        p.test(null, Number.class);
        /*[Transform from] assertFalse(p.test("foo", Number.class));*/
        p.test("foo", Number.class);
    ...
    public void testTest_3() throws Exception {
        ...
        /*[Transform from] assertFalse(p.test("foo", Number.class));*/
        p.test("foo", Number.class);
        /*[Transform from] assertTrue(p.test(3, Number.class));*/
        p.test(3, Number.class);
    ...
    @Test
    public void testBoundTest_1() throws Exception {
        Predicate<Object> p = IsInstance.of(Number.class);
        /*[Transform from] assertFalse(p.test(null));*/
        p.test(null);
        assertFalse(p.test("foo"));
    }

    @Test
    public void testBoundTest_2() throws Exception {
        Predicate<Object> p = IsInstance.of(Number.class);
        /*[Transform from] assertFalse(p.test(null));*/
        p.test(null);
    ...
    @Test
    public void testBoundTest_3() throws Exception {
        Predicate<Object> p = IsInstance.of(Number.class);
        /*[Transform from] assertFalse(p.test(null));*/
        p.test(null);
        /*[Transform from] assertFalse(p.test("foo"));*/
        p.test("foo");
        /*[Transform from] assertTrue(p.test(3));*/
        p.test(3);
