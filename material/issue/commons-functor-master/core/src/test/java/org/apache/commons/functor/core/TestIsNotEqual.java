...
public class TestIsNotEqual extends BaseFunctorTest {
    ...
    public void testTest_1() throws Exception {
        IsNotEqual<Object, Object> p = new IsNotEqual<Object, Object>();
        /*[Transform from] assertTrue("For symmetry, two nulls should be equal", !p.test(null, null));[NONE Params]*/
        ;
    ...
    public void testTest_2() throws Exception {
        ...
        /*[Transform from] assertTrue("For symmetry, two nulls should be equal", !p.test(null, null));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!p.test("foo", "foo"));[NONE Params]*/
        ;
    ...
    public void testTest_5() throws Exception {
        ...
        /*[Transform from] assertTrue(p.test("foo", null));*/
        p.test("foo", null);
        /*[Transform from] assertTrue(!p.test(Integer.valueOf(3), Integer.valueOf(3)));[NONE Params]*/
        ;
    ...
    public void testToPredicate_1() {
        Predicate<Integer> isNotEqual = IsNotEqual.to(Integer.valueOf(1));
        /*[Transform from] assertTrue(isNotEqual.test(Integer.valueOf(2)));*/
        isNotEqual.test(Integer.valueOf(2));
