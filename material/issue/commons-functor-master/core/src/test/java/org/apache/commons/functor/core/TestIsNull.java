...
public class TestIsNull extends BaseFunctorTest {
    ...
    public void testTest_1() throws Exception {
        Predicate<Object> p = new IsNull<Object>();
        /*[Transform from] assertTrue(p.test(null));*/
        p.test(null);
    ...
    public void testTest_2() throws Exception {
        ...
        /*[Transform from] assertTrue(p.test(null));*/
        p.test(null);
        /*[Transform from] assertFalse(p.test("foo"));*/
        p.test("foo");
    ...
    @Test
    public void testAsBinary_1() throws Exception {
        /*[Transform from] assertTrue(IsNull.left().test(null, "not null"));*/
        IsNull.left().test(null, "not null");
        assertFalse(IsNull.left().test("not null", null));
    }

    @Test
    public void testAsBinary_2() throws Exception {
        /*[Transform from] assertTrue(IsNull.left().test(null, "not null"));*/
        IsNull.left().test(null, "not null");
        /*[Transform from] assertFalse(IsNull.left().test("not null", null));*/
        IsNull.left().test("not null", null);
        assertTrue(IsNull.right().test("not null", null));
    }

    @Test
    public void testAsBinary_3() throws Exception {
        /*[Transform from] assertTrue(IsNull.left().test(null, "not null"));*/
        IsNull.left().test(null, "not null");
        /*[Transform from] assertFalse(IsNull.left().test("not null", null));*/
        IsNull.left().test("not null", null);
        /*[Transform from] assertTrue(IsNull.right().test("not null", null));*/
        IsNull.right().test("not null", null);
