...
public class TestOffset extends BaseFunctorTest {
    ...
    @Test
    public void testTestNullary_1() throws Exception {
        NullaryPredicate p = new Offset(3);
    ...
    @Test
    public void testTestUnary_1() throws Exception {
        Predicate<Object> p = new Offset(3);
        /*[Transform from] assertTrue(!p.test(null));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!p.test(null));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!p.test(null));[NONE Params]*/
    ...
    @Test
    public void testTestBinary_1() throws Exception {
        BinaryPredicate<Object, Object> p = new Offset(3);
        /*[Transform from] assertTrue(!p.test(null, null));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!p.test(null, null));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!p.test(null, null));[NONE Params]*/
