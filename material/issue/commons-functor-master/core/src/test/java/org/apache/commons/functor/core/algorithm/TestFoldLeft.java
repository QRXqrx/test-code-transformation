...
public class TestFoldLeft extends BaseFunctorTest {
    ...
    public void testFoldLeft_1() {
        ...
        /*[Transform from] assertEquals(Integer.valueOf(sum), foldLeft.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator())));*/
        {
            Integer.valueOf(sum);
    ...
    public void testFoldLeft_2() {
        ...
        /*[Transform from] assertEquals(Integer.valueOf(sum), foldLeft.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator()), Integer.valueOf(0)));*/
        {
            Integer.valueOf(sum);
            foldLeft.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator()), Integer.valueOf(0));
        }
