...
public class TestFoldRight extends BaseFunctorTest {
    ...
    public void testFoldRight_1() {
        ...
        /*[Transform from] assertEquals("0123456789", foldRight.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator())).toString());*/
    ...
    public void testFoldRight_2() {
        ...
        /*[Transform from] assertEquals("0123456789", foldRight.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator())).toString());*/
        foldRight.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator())).toString();
        /*[Transform from] assertEquals("0123456789x", foldRight.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator()), "x").toString());*/
        foldRight.evaluate(IteratorToGeneratorAdapter.adapt(list.iterator()), "x").toString();
