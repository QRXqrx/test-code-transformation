...
public class TestGeneratorContains extends BaseFunctorTest {
    ...
    public void testContains_1() {
        /*[Transform from] assertTrue(new GeneratorContains<Integer>().test(IteratorToGeneratorAdapter.adapt(list.iterator()), equalsThree));*/
        new GeneratorContains<Integer>().test(IteratorToGeneratorAdapter.adapt(list.iterator()), equalsThree);
