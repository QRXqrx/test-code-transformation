...
public class TestRecursiveEvaluation extends BaseFunctorTest {
    ...
    @Test
    public void testRecurse_1() {
        /*[Transform from] assertEquals(Integer.valueOf(5), new RecursiveEvaluation(new RecFunc(0, false)).evaluate());*/
        {
            Integer.valueOf(5);
            new RecursiveEvaluation(new RecFunc(0, false)).evaluate();
        }
    ...
    public void testConstructors_1() {
        try {
            new RecursiveEvaluation(new RecFunc(0, false), java.lang.Integer.class);
            /*[Transform from] fail("Not supposed to get here.");[NONE Params]*/
            ;
        } catch (IllegalArgumentException e) {
        }
        try {
