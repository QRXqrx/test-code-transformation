...
public class TestFilteredIterable extends BaseFunctorTest {
    ...
    @Test
    public void testSomePass_1() {
        Iterator<Integer> expected = evens.iterator();
        FilteredIterable<Integer> filter = FilteredIterable.of(list);
        for (Integer i : filter.retain(isEven)) {
            /*[Transform from] assertTrue(expected.hasNext());*/
            expected.hasNext();
            /*[Transform from] assertEquals(expected.next(), i);*/
            expected.next();
        }
    ...
    public void testSomePass_2() {
        ...
        /*[Transform from] assertFalse(expected.hasNext());*/
        expected.hasNext();
    ...
    @Test
    public void testEmptyFilteredIterable_1() {
        FilteredIterable<Integer> emptyFilter = FilteredIterable.empty();
        /*[Transform from] assertFalse(emptyFilter.iterator().hasNext());*/
        emptyFilter.iterator().hasNext();
        assertEquals(emptyFilter, emptyFilter.retain(isEven));
    }

    @Test
    public void testEmptyFilteredIterable_2() {
        FilteredIterable<Integer> emptyFilter = FilteredIterable.empty();
        /*[Transform from] assertFalse(emptyFilter.iterator().hasNext());*/
        emptyFilter.iterator().hasNext();
        /*[Transform from] assertEquals(emptyFilter, emptyFilter.retain(isEven));*/
        emptyFilter.retain(isEven);
        assertEquals(emptyFilter, emptyFilter.retain(Integer.class));
    }

    @Test
    public void testEmptyFilteredIterable_3() {
        FilteredIterable<Integer> emptyFilter = FilteredIterable.empty();
        /*[Transform from] assertFalse(emptyFilter.iterator().hasNext());*/
        emptyFilter.iterator().hasNext();
        /*[Transform from] assertEquals(emptyFilter, emptyFilter.retain(isEven));*/
        emptyFilter.retain(isEven);
        /*[Transform from] assertEquals(emptyFilter, emptyFilter.retain(Integer.class));*/
        emptyFilter.retain(Integer.class);
    ...
    @Test
    public void testNextWithoutHasNext_1() {
        Iterator<Integer> testing = FilteredIterable.of(list).retain(isEven).iterator();
        Iterator<Integer> expected = evens.iterator();
        while (expected.hasNext()) {
            /*[Transform from] assertEquals(expected.next(), testing.next());*/
            {
                expected.next();
                testing.next();
            }
    ...
    @Test
    public void testRetainOneType2_1() {
        Iterable<Object> objects = Arrays.asList((Object) "foo", "bar", "baz", 2L, BigInteger.ZERO);
        Iterator<Number> iterator = FilteredIterable.of(objects).retain(Number.class).iterator();
        /*[Transform from] assertEquals(2L, iterator.next());*/
        iterator.next();
        assertEquals(BigInteger.ZERO, iterator.next());
    }

    @Test
    public void testRetainOneType2_2() {
        Iterable<Object> objects = Arrays.asList((Object) "foo", "bar", "baz", 2L, BigInteger.ZERO);
        Iterator<Number> iterator = FilteredIterable.of(objects).retain(Number.class).iterator();
        /*[Transform from] assertEquals(2L, iterator.next());*/
        iterator.next();
        /*[Transform from] assertEquals(BigInteger.ZERO, iterator.next());*/
        iterator.next();
    ...
    @Test
    public void testRetainMultipleTypes_1() {
        Iterable<Object> objects = Arrays.asList((Object) "foo", "bar", "baz", 2L, BigInteger.ZERO);
        Iterator<Object> iterator = FilteredIterable.of(objects).retain(Long.class, BigInteger.class).iterator();
        /*[Transform from] assertEquals(2L, iterator.next());*/
        iterator.next();
    ...
    @Test
    public void testRetainMultipleTypes_2() {
        Iterable<Object> objects = Arrays.asList((Object) "foo", "bar", "baz", 2L, BigInteger.ZERO);
        Iterator<Object> iterator = FilteredIterable.of(objects).retain(Long.class, BigInteger.class).iterator();
        /*[Transform from] assertEquals(2L, iterator.next());*/
        iterator.next();
    ...
    @Test
    public void testMultipleLevels_1() {
        Iterable<Object> objects = Arrays.asList((Object) "foo", "bar", "baz", 2L, BigInteger.ZERO);
        Iterator<String> iterator = FilteredIterable.of(objects).retain(String.class).retain(IsEqual.to("foo")).iterator();
        /*[Transform from] assertEquals("foo", iterator.next());*/
        iterator.next();
        assertFalse(iterator.hasNext());
    }
    ...
    @Test
    public void testMultipleLevels2_1() {
        Iterable<Object> objects = Arrays.asList((Object) "foo", "bar", "baz", 2L, BigInteger.ZERO);
        Iterator<Long> iterator = FilteredIterable.of(objects).retain(Number.class).retain(Long.class).iterator();
        /*[Transform from] assertEquals(2L, iterator.next().longValue());*/
