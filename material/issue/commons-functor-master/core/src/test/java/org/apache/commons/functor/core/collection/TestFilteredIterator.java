...
public class TestFilteredIterator extends BaseFunctorTest {
    ...
    public void testSomePass_1() {
        ...
        Iterator<Integer> testing = new FilteredIterator<Integer>(list.iterator(), isEven);
        while (expected.hasNext()) {
            /*[Transform from] assertTrue(testing.hasNext());*/
            testing.hasNext();
    ...
    public void testEquals_1() {
        ...
        /*[Transform from] assertEquals(t, new FilteredIterator<Integer>(iter, isEven));[NONE Params]*/
        ;
    ...
    public void testEquals_2() {
        ...
        /*[Transform from] assertEquals(t, new FilteredIterator<Integer>(iter, isEven));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!t.equals(new FilteredIterator<Integer>(list.iterator(), isOdd)));[NONE Params]*/
        ;
    ...
    public void testEquals_3() {
        ...
        /*[Transform from] assertTrue(!t.equals(new FilteredIterator<Integer>(list.iterator(), isOdd)));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!t.equals(new FilteredIterator<Float>(Arrays.asList(0.0f, 0.1f).iterator(), isOddFloat)));[NONE Params]*/
        ;
