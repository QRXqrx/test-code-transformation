...
public class TestIsEmpty extends BaseFunctorTest {
    ...
    public void testTest_1() throws Exception {
        /*[Transform from] assertTrue(IsEmpty.instance().test(Collections.EMPTY_LIST));*/
        IsEmpty.instance().test(Collections.EMPTY_LIST);
    ...
    public void testTestArray_1() throws Exception {
        /*[Transform from] assertTrue(!IsEmpty.instance().test(new int[10]));[NONE Params]*/
        ;
    ...
    public void testTestArray_2() throws Exception {
        /*[Transform from] assertTrue(!IsEmpty.instance().test(new int[10]));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!IsEmpty.instance().test(new Object[10]));[NONE Params]*/
        ;
    ...
    public void testTestArray_3() throws Exception {
        ...
        /*[Transform from] assertTrue(!IsEmpty.instance().test(new Object[10]));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(IsEmpty.instance().test(new int[0]));*/
        IsEmpty.instance().test(new int[0]);
    ...
    @Test
    public void testTestString_1() throws Exception {
        /*[Transform from] assertTrue(!IsEmpty.instance().test("xyzzy"));[NONE Params]*/
        ;
    ...
    @Test
    public void testTestMap_1() throws Exception {
        Map<String, String> map = new HashMap<String, String>();
        /*[Transform from] assertTrue(IsEmpty.instance().test(map));*/
        IsEmpty.instance().test(map);
        map.put("x", "y");
        assertTrue(!IsEmpty.instance().test(map));
    }
