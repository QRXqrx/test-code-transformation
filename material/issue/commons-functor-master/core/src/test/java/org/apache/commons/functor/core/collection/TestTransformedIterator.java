...
public class TestTransformedIterator extends BaseFunctorTest {
    ...
    @Test
    public void testBasicTransform_1() {
        Iterator<Integer> expected = negatives.iterator();
        Iterator<Integer> testing = new TransformedIterator<Integer, Integer>(list.iterator(), negate);
        while (expected.hasNext()) {
    ...
    public void testEquals_1() {
        ...
        /*[Transform from] assertEquals(t, new TransformedIterator<Integer, Integer>(iter, negate));[NONE Params]*/
        ;
    ...
    public void testEquals_2() {
        ...
        /*[Transform from] assertEquals(t, new TransformedIterator<Integer, Integer>(iter, negate));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!t.equals(new TransformedIterator<Integer, Double>(list.iterator(), negateDouble)));[NONE Params]*/
        ;
    ...
    public void testEquals_3() {
        ...
        /*[Transform from] assertTrue(!t.equals(new TransformedIterator<Integer, Double>(list.iterator(), negateDouble)));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!t.equals(new TransformedIterator<Float, Integer>(Arrays.asList(0.0f, 0.1f).iterator(), negate)));[NONE Params]*/
        ;
