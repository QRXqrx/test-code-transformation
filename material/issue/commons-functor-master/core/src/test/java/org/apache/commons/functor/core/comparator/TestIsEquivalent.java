...
public class TestIsEquivalent extends BaseComparisonPredicateTest {
    ...
    public void testTest_1() throws Exception {
        IsEquivalent<Integer> p = IsEquivalent.<Integer>instance();
        /*[Transform from] assertTrue(!p.test(Integer.valueOf(2), Integer.valueOf(4)));[NONE Params]*/
        ;
    ...
    public void testTest_2() throws Exception {
        ...
        /*[Transform from] assertTrue(!p.test(Integer.valueOf(2), Integer.valueOf(4)));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!p.test(Integer.valueOf(3), Integer.valueOf(4)));[NONE Params]*/
        ;
    ...
    public void testTest_4() throws Exception {
        ...
        /*[Transform from] assertTrue(p.test(Integer.valueOf(4), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(4), Integer.valueOf(4));
        /*[Transform from] assertTrue(!p.test(Integer.valueOf(5), Integer.valueOf(4)));[NONE Params]*/
        ;
    ...
    public void testInstance_1() {
        /*[Transform from] assertTrue(IsEquivalent.instance("Xyzzy").test("Xyzzy"));*/
        IsEquivalent.instance("Xyzzy").test("Xyzzy");
