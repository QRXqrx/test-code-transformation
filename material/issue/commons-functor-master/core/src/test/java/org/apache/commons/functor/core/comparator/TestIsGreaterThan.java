...
public class TestIsGreaterThan extends BaseComparisonPredicateTest {
    ...
    public void testTest_3() throws Exception {
        ...
        /*[Transform from] assertFalse(p.test(Integer.valueOf(3), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(3), Integer.valueOf(4));
        /*[Transform from] assertFalse(p.test(Integer.valueOf(4), Integer.valueOf(4)));*/
    ...
    public void testInstance_1() {
        /*[Transform from] assertTrue(IsGreaterThan.instance(Integer.valueOf(7)).test(Integer.valueOf(8)));*/
        IsGreaterThan.instance(Integer.valueOf(7)).test(Integer.valueOf(8));
