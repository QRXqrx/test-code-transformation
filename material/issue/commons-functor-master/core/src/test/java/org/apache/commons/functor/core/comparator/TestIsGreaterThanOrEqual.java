...
public class TestIsGreaterThanOrEqual extends BaseComparisonPredicateTest {
    ...
    public void testTest_1() throws Exception {
        IsGreaterThanOrEqual<Integer> p = new IsGreaterThanOrEqual<Integer>();
        /*[Transform from] assertFalse(p.test(Integer.valueOf(2), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(2), Integer.valueOf(4));
    ...
    public void testTest_3() throws Exception {
        ...
        /*[Transform from] assertFalse(p.test(Integer.valueOf(3), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(3), Integer.valueOf(4));
        /*[Transform from] assertTrue(p.test(Integer.valueOf(4), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(4), Integer.valueOf(4));
    ...
    public void testTest_4() throws Exception {
        ...
        /*[Transform from] assertTrue(p.test(Integer.valueOf(4), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(4), Integer.valueOf(4));
        /*[Transform from] assertTrue(p.test(Integer.valueOf(5), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(5), Integer.valueOf(4));
    ...
    @Test
    public void testInstance_1() {
        /*[Transform from] assertTrue(IsGreaterThanOrEqual.instance(Integer.valueOf(7)).test(Integer.valueOf(8)));*/
        IsGreaterThanOrEqual.instance(Integer.valueOf(7)).test(Integer.valueOf(8));
