...
public class TestIsLessThanOrEqual extends BaseComparisonPredicateTest {
    ...
    public void testTest_1() throws Exception {
        IsLessThanOrEqual<Integer> p = new IsLessThanOrEqual<Integer>();
        /*[Transform from] assertTrue(p.test(Integer.valueOf(2), Integer.valueOf(4)));*/
    ...
    public void testTest_4() throws Exception {
        ...
        /*[Transform from] assertTrue(p.test(Integer.valueOf(4), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(4), Integer.valueOf(4));
        /*[Transform from] assertFalse(p.test(Integer.valueOf(5), Integer.valueOf(4)));*/
    ...
    public void testInstance_1() {
        /*[Transform from] assertFalse(IsLessThanOrEqual.instance(Integer.valueOf(7)).test(Integer.valueOf(8)));*/
        IsLessThanOrEqual.instance(Integer.valueOf(7)).test(Integer.valueOf(8));
