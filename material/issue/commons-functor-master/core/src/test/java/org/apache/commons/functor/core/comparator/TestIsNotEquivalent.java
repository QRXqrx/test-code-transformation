...
public class TestIsNotEquivalent extends BaseComparisonPredicateTest {
    ...
    public void testTest_3() throws Exception {
        ...
        /*[Transform from] assertTrue(p.test(Integer.valueOf(3), Integer.valueOf(4)));*/
        p.test(Integer.valueOf(3), Integer.valueOf(4));
        /*[Transform from] assertTrue(!p.test(Integer.valueOf(4), Integer.valueOf(4)));[NONE Params]*/
        ;
    ...
    public void testInstance_1() {
        /*[Transform from] assertTrue(!IsNotEquivalent.instance(Integer.valueOf(7)).test(Integer.valueOf(7)));[NONE Params]*/
        ;
