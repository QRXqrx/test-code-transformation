...
public class TestMax extends BaseFunctorTest {
    ...
    public void testEvaluate_2() {
        ...
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, ONE));*/
        f.evaluate(ONE, ONE);
        /*[Transform from] assertEquals(ONE, f.evaluate(ZERO, ONE));*/
        f.evaluate(ZERO, ONE);
    ...
    public void testEvaluate_3() {
        ...
        /*[Transform from] assertEquals(ONE, f.evaluate(ZERO, ONE));*/
        f.evaluate(ZERO, ONE);
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, ZERO));*/
        f.evaluate(ONE, ZERO);
    ...
    public void testEvaluate_4() {
        ...
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, ZERO));*/
        f.evaluate(ONE, ZERO);
        /*[Transform from] assertEquals(MAX, f.evaluate(ONE, MAX));*/
        f.evaluate(ONE, MAX);
    ...
    public void testEvaluate_5() {
        ...
        /*[Transform from] assertEquals(MAX, f.evaluate(ONE, MAX));*/
        f.evaluate(ONE, MAX);
        /*[Transform from] assertEquals(MAX, f.evaluate(MIN, MAX));*/
        f.evaluate(MIN, MAX);
