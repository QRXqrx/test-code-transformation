...
public class TestMin extends BaseFunctorTest {
    ...
    public void testEvaluate_1() {
        Min<Integer> f = Min.instance();
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, ONE));*/
        f.evaluate(ONE, ONE);
    ...
    public void testEvaluate_2() {
        ...
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, ONE));*/
        f.evaluate(ONE, ONE);
        /*[Transform from] assertEquals(ZERO, f.evaluate(ZERO, ONE));*/
        f.evaluate(ZERO, ONE);
    ...
    public void testEvaluate_3() {
        ...
        /*[Transform from] assertEquals(ZERO, f.evaluate(ZERO, ONE));*/
        f.evaluate(ZERO, ONE);
        /*[Transform from] assertEquals(ZERO, f.evaluate(ONE, ZERO));*/
        f.evaluate(ONE, ZERO);
    ...
    public void testEvaluate_4() {
        ...
        /*[Transform from] assertEquals(ZERO, f.evaluate(ONE, ZERO));*/
        f.evaluate(ONE, ZERO);
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, MAX));*/
        f.evaluate(ONE, MAX);
    ...
    public void testEvaluate_5() {
        ...
        /*[Transform from] assertEquals(ONE, f.evaluate(ONE, MAX));*/
        f.evaluate(ONE, MAX);
        /*[Transform from] assertEquals(MIN, f.evaluate(MIN, MAX));*/
        f.evaluate(MIN, MAX);
