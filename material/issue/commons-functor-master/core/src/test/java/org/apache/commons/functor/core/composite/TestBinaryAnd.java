...
public class TestBinaryAnd extends BaseFunctorTest {
    ...
    public void testTrue_1() throws Exception {
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>()).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>()).test("xyzzy", 3);
    ...
    public void testTrue_2() throws Exception {
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>()).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>()).test("xyzzy", 3);
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>(Constant.TRUE)).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>(Constant.TRUE)).test("xyzzy", 3);
    ...
    public void testTrue_3() throws Exception {
        ...
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>(Constant.TRUE)).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>(Constant.TRUE)).test("xyzzy", 3);
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE)).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE)).test("xyzzy", 3);
    ...
    public void testTrue_4() throws Exception {
        ...
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE)).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE)).test("xyzzy", 3);
        /*[Transform from] assertTrue((new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE, Constant.TRUE)).test("xyzzy", 3));*/
        (new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE, Constant.TRUE)).test("xyzzy", 3);
    ...
    public void testTrue_5() throws Exception {
        ...
        (new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE, Constant.TRUE)).test("xyzzy", 3);
        BinaryAnd<String, Integer> p = new BinaryAnd<String, Integer>(Constant.TRUE);
        /*[Transform from] assertTrue(p.test("xyzzy", 3));*/
        p.test("xyzzy", 3);
        for (int i = 0; i < 10; i++) {
            p.and(Constant.TRUE);
            assertTrue(p.test("xyzzy", 3));
    ...
    public void testTrue_7() throws Exception {
        ...
        BinaryAnd<String, Integer> q = new BinaryAnd<String, Integer>(Constant.TRUE);
        /*[Transform from] assertTrue(q.test("xyzzy", 3));*/
        q.test("xyzzy", 3);
        for (int i = 0; i < 10; i++) {
            q.and(Constant.TRUE);
            assertTrue(q.test("xyzzy", 3));
    ...
    public void testFalse_1() throws Exception {
        /*[Transform from] assertTrue(!(new BinaryAnd<String, Integer>(Constant.FALSE)).test("xyzzy", 3));[NONE Params]*/
        ;
    ...
    public void testFalse_2() throws Exception {
        /*[Transform from] assertTrue(!(new BinaryAnd<String, Integer>(Constant.FALSE)).test("xyzzy", 3));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!(new BinaryAnd<String, Integer>(Constant.TRUE, Constant.FALSE)).test("xyzzy", 3));[NONE Params]*/
        ;
    ...
    public void testFalse_3() throws Exception {
        ...
        /*[Transform from] assertTrue(!(new BinaryAnd<String, Integer>(Constant.TRUE, Constant.FALSE)).test("xyzzy", 3));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!(new BinaryAnd<String, Integer>(Constant.TRUE, Constant.TRUE, Constant.FALSE)).test("xyzzy", 3));[NONE Params]*/
        ;
    ...
    public void testFalse_4() throws Exception {
        ...
        ;
        BinaryAnd<String, Integer> p = new BinaryAnd<String, Integer>(Constant.FALSE);
        /*[Transform from] assertTrue(!p.test("xyzzy", 3));[NONE Params]*/
        ;
        for (int i = 0; i < 10; i++) {
