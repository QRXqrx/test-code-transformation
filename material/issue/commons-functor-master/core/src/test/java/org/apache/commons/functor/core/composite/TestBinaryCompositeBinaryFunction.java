...
public class TestBinaryCompositeBinaryFunction extends BaseFunctorTest {
    ...
    @Test
    public void testEvaluateRaw_1() throws Exception {
        BinaryFunction<Object, Object, Object> f = new BinaryCompositeBinaryFunction<Object, Object, Object>(RightIdentity.FUNCTION, Constant.of("K"), RightIdentity.FUNCTION);
    ...
    @Test
    public void testEvaluateRaw_2() throws Exception {
        BinaryFunction<Object, Object, Object> f = new BinaryCompositeBinaryFunction<Object, Object, Object>(RightIdentity.FUNCTION, Constant.of("K"), RightIdentity.FUNCTION);
        /*[Transform from] assertEquals("right", f.evaluate("left", "right"));*/
        f.evaluate("left", "right");
    ...
    @Test
    public void testEvaluateObject_1() throws Exception {
        BinaryFunction<Object, Object, Object> f = new BinaryCompositeBinaryFunction<Object, Object, Object>(RightIdentity.FUNCTION, Constant.of("K"), RightIdentity.FUNCTION);
        /*[Transform from] assertEquals("right", f.evaluate("left", "right"));*/
        f.evaluate("left", "right");
        assertNull("right", f.evaluate("left", null));
    ...
    @Test
    public void testEvaluateObject_2() throws Exception {
        BinaryFunction<Object, Object, Object> f = new BinaryCompositeBinaryFunction<Object, Object, Object>(RightIdentity.FUNCTION, Constant.of("K"), RightIdentity.FUNCTION);
        /*[Transform from] assertEquals("right", f.evaluate("left", "right"));*/
        f.evaluate("left", "right");
        /*[Transform from] assertNull("right", f.evaluate("left", null));*/
    ...
    public void testEquals_2() throws Exception {
        ...
        assertObjectsAreNotEqual(f, new BinaryCompositeBinaryFunction<Object, Object, Object>(LeftIdentity.FUNCTION, Constant.of("left"), RightIdentity.FUNCTION));
        assertObjectsAreNotEqual(f, new BinaryCompositeBinaryFunction<Object, Object, Object>(LeftIdentity.FUNCTION, Constant.of("rigth"), Constant.of("right")));
        /*[Transform from] assertTrue(!f.equals(null));[NONE Params]*/
        ;
