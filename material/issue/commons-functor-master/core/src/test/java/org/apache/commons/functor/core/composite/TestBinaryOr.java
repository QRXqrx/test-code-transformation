...
public class TestBinaryOr extends BaseFunctorTest {
    ...
    public void testTrue_1() throws Exception {
        /*[Transform from] assertTrue((new BinaryOr<Object, Object>(Constant.TRUE)).test("xyzzy", Integer.valueOf(3)));*/
        (new BinaryOr<Object, Object>(Constant.TRUE)).test("xyzzy", Integer.valueOf(3));
    ...
    public void testTrue_2() throws Exception {
        /*[Transform from] assertTrue((new BinaryOr<Object, Object>(Constant.TRUE)).test("xyzzy", Integer.valueOf(3)));*/
        (new BinaryOr<Object, Object>(Constant.TRUE)).test("xyzzy", Integer.valueOf(3));
        /*[Transform from] assertTrue((new BinaryOr<Object, Object>(Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3)));*/
        (new BinaryOr<Object, Object>(Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3));
    ...
    public void testTrue_3() throws Exception {
        ...
        /*[Transform from] assertTrue((new BinaryOr<Object, Object>(Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3)));*/
        (new BinaryOr<Object, Object>(Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3));
        /*[Transform from] assertTrue((new BinaryOr<Object, Object>(Constant.FALSE, Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3)));*/
        (new BinaryOr<Object, Object>(Constant.FALSE, Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3));
    ...
    public void testTrue_4() throws Exception {
        ...
        (new BinaryOr<Object, Object>(Constant.FALSE, Constant.FALSE, Constant.TRUE)).test("xyzzy", Integer.valueOf(3));
        BinaryOr<Object, Object> p = new BinaryOr<Object, Object>(Constant.TRUE);
        /*[Transform from] assertTrue(p.test("xyzzy", Integer.valueOf(3)));*/
        p.test("xyzzy", Integer.valueOf(3));
        for (int i = 0; i < 10; i++) {
    ...
    public void testTrue_6() throws Exception {
        ...
        BinaryOr<Object, Object> q = new BinaryOr<Object, Object>(Constant.TRUE);
        /*[Transform from] assertTrue(q.test("xyzzy", Integer.valueOf(3)));*/
        q.test("xyzzy", Integer.valueOf(3));
        for (int i = 0; i < 10; i++) {
    ...
    public void testFalse_1() throws Exception {
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>()).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
    ...
    public void testFalse_2() throws Exception {
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>()).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>(Constant.FALSE)).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
    ...
    public void testFalse_3() throws Exception {
        ...
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>(Constant.FALSE)).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>(Constant.FALSE, Constant.FALSE)).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
    ...
    public void testFalse_4() throws Exception {
        ...
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>(Constant.FALSE, Constant.FALSE)).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!(new BinaryOr<Object, Object>(Constant.FALSE, Constant.FALSE, Constant.FALSE)).test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
    ...
    public void testFalse_5() throws Exception {
        ...
        ;
        BinaryOr<Object, Object> p = new BinaryOr<Object, Object>(Constant.FALSE);
        /*[Transform from] assertTrue(!p.test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
        for (int i = 0; i < 10; i++) {
            p.or(Constant.FALSE);
            assertTrue(!p.test("xyzzy", Integer.valueOf(3)));
    ...
    public void testFalse_7() throws Exception {
        ...
        BinaryOr<Object, Object> q = new BinaryOr<Object, Object>(Constant.FALSE);
        /*[Transform from] assertTrue(!q.test("xyzzy", Integer.valueOf(3)));[NONE Params]*/
        ;
        for (int i = 0; i < 10; i++) {
            q.or(Constant.FALSE);
            assertTrue(!q.test("xyzzy", Integer.valueOf(3)));
