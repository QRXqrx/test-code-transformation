...
public class TestCompositeFunction extends BaseFunctorTest {
    ...
    public void testEvaluate_1() throws Exception {
        /*[Transform from] assertEquals(Integer.valueOf(4), (new CompositeFunction<Object, Integer>(Constant.of(4))).evaluate(null));*/
        {
            Integer.valueOf(4);
            (new CompositeFunction<Object, Integer>(Constant.of(4))).evaluate(null);
        }
    ...
    public void testEvaluate_2() throws Exception {
        ...
        /*[Transform from] assertEquals(Integer.valueOf(4), (Composite.function(Constant.of(4)).of(Constant.of(3)).evaluate("xyzzy")));*/
        Integer.valueOf(4);
