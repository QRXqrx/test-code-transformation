...
public class TestCompositePredicate extends BaseFunctorTest {
    ...
    public void testTest_1() throws Exception {
        /*[Transform from] assertTrue(Composite.predicate(Constant.TRUE).test(null));*/
        Composite.predicate(Constant.TRUE).test(null);
    ...
    public void testTest_2() throws Exception {
        /*[Transform from] assertTrue(Composite.predicate(Constant.TRUE).test(null));*/
        Composite.predicate(Constant.TRUE).test(null);
        /*[Transform from] assertTrue(Composite.predicate(Constant.TRUE, Constant.of(3)).test("xyzzy"));*/
        Composite.predicate(Constant.TRUE, Constant.of(3)).test("xyzzy");
    ...
    public void testOf_1() throws Exception {
        CompositePredicate<Object> f = new CompositePredicate<Object>(Constant.TRUE);
        /*[Transform from] assertTrue(f.test(null));*/
        f.test(null);
        for (int i = 0; i < 10; i++) {
