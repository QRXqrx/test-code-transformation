...
public class TestDoWhileNullaryProcedure extends BaseFunctorTest {
    ...
    @Test
    public void testLoopWithAction_1() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        /*[Transform from] assertTrue("The condition should be true before running the loop", condition.test());*/
        condition.test();
        assertFalse("The list should not be empty then", list.isEmpty());
    }

    @Test
    public void testLoopWithAction_2() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        /*[Transform from] assertTrue("The condition should be true before running the loop", condition.test());*/
        condition.test();
        /*[Transform from] assertFalse("The list should not be empty then", list.isEmpty());*/
        list.isEmpty();
        procedure.run();
    ...
    @Test
    public void testLoopWithAction_3() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        ...
        list.isEmpty();
        procedure.run();
        /*[Transform from] assertFalse("The condition should be false after running the loop", condition.test());*/
        condition.test();
        assertTrue("The list should be empty then", list.isEmpty());
    }

    @Test
    public void testLoopWithAction_4() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        ...
        /*[Transform from] assertFalse("The condition should be false after running the loop", condition.test());*/
        condition.test();
        /*[Transform from] assertTrue("The list should be empty then", list.isEmpty());*/
        list.isEmpty();
        list = getList();
    ...
    @Test
    public void testLoopWithAction_5() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        ...
        procedure = new DoWhileNullaryProcedure(action, condition);
        procedure.run();
        /*[Transform from] assertFalse("The list should not contain \"a\" anymore", list.contains("a"));*/
        list.contains("a");
        assertFalse("The list should not contain \"b\" anymore", list.contains("b"));
    }

    @Test
    public void testLoopWithAction_6() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        ...
        /*[Transform from] assertFalse("The list should not contain \"a\" anymore", list.contains("a"));*/
        list.contains("a");
        /*[Transform from] assertFalse("The list should not contain \"b\" anymore", list.contains("b"));*/
        list.contains("b");
        assertFalse("The list should not contain \"c\" anymore", list.contains("c"));
    }

    @Test
    public void testLoopWithAction_7() throws Exception {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryPredicate condition = new NullaryNot(new BoundNullaryPredicate(new IsEmpty<List<Object>>(), list));
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, condition);
        ...
        /*[Transform from] assertFalse("The list should not contain \"b\" anymore", list.contains("b"));*/
        list.contains("b");
        /*[Transform from] assertFalse("The list should not contain \"c\" anymore", list.contains("c"));*/
        list.contains("c");
    ...
    @Test
    public void testLoopForNothing_1() {
        List<Object> list = getList();
        NullaryProcedure action = new ListRemoveFirstProcedure(list);
        NullaryProcedure procedure = new DoWhileNullaryProcedure(action, Constant.FALSE);
        /*[Transform from] assertTrue("The list should contain 4 elements before runnning the loop", list.size() == 4);[NONE Params]*/
        ;
        procedure.run();
