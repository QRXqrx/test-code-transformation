...
public class FlexiMapExample {
     ...
     */
    @Test
    public void testBasicMapAllowsMultipleTypes_1() {
        Map<Object, Object> map = makeBasicMap();
        map.put("key-1", "value-1");
        map.put(Integer.valueOf(2), "value-2");
        map.put("key-3", Integer.valueOf(3));
        map.put(Integer.valueOf(4), Integer.valueOf(4));
        /*[Transform from] assertEquals("value-1", map.get("key-1"));*/
        map.get("key-1");
     ...
     */
    @Test
    public void testBasicMapAllowsMultipleTypes_2() {
        Map<Object, Object> map = makeBasicMap();
        map.put("key-1", "value-1");
        map.put(Integer.valueOf(2), "value-2");
        map.put("key-3", Integer.valueOf(3));
        ...
        /*[Transform from] assertEquals("value-1", map.get("key-1"));*/
        map.get("key-1");
        /*[Transform from] assertEquals("value-2", map.get(Integer.valueOf(2)));*/
     ...
     */
    @Test
    public void testBasicMapAllowsMultipleTypes_3() {
        Map<Object, Object> map = makeBasicMap();
        map.put("key-1", "value-1");
        map.put(Integer.valueOf(2), "value-2");
        map.put("key-3", Integer.valueOf(3));
        ...
        /*[Transform from] assertEquals("value-2", map.get(Integer.valueOf(2)));*/
        map.get(Integer.valueOf(2));
        /*[Transform from] assertEquals(Integer.valueOf(3), map.get("key-3"));*/
        {
            Integer.valueOf(3);
            map.get("key-3");
        }
     ...
     */
    @Test
    public void testBasicMapStoresOnlyOneValuePerKey_1() {
        Map<Object, Object> map = makeBasicMap();
        /*[Transform from] assertNull(map.put("key", "value-1"));*/
        map.put("key", "value-1");
     ...
     */
    @Test
    public void testBasicMapStoresOnlyOneValuePerKey_2() {
        Map<Object, Object> map = makeBasicMap();
        /*[Transform from] assertNull(map.put("key", "value-1"));*/
        map.put("key", "value-1");
        /*[Transform from] assertEquals("value-1", map.get("key"));*/
        map.get("key");
     ...
     */
    @Test
    public void testBasicMapStoresOnlyOneValuePerKey_3() {
        Map<Object, Object> map = makeBasicMap();
        /*[Transform from] assertNull(map.put("key", "value-1"));*/
        map.put("key", "value-1");
        /*[Transform from] assertEquals("value-1", map.get("key"));*/
        map.get("key");
        /*[Transform from] assertEquals("value-1", map.put("key", "value-2"));*/
        map.put("key", "value-2");
     ...
     */
    @Test
    public void testNullDefaultsToZero_1() {
        Map<Object, Object> map = makeDefaultValueForNullMap(Integer.valueOf(0));
        /*[Transform from] assertEquals(Integer.valueOf(0), map.get("key"));*/
        {
            Integer.valueOf(0);
            map.get("key");
        }
     ...
     */
    @Test
    public void testIntegerValuesOnly_1() {
        Map<Object, Object> map = makeTypeConstrainedMap(Integer.class);
        map.put("key", Integer.valueOf(2));
        /*[Transform from] assertEquals(Integer.valueOf(2), map.get("key"));*/
        {
            Integer.valueOf(2);
            map.get("key");
        }
     ...
     */
    @Test
    public void testStringConcatMap_1() {
        Map<Object, Object> map = makeStringConcatMap();
        map.put("key", "value 1");
        /*[Transform from] assertEquals("value 1", map.get("key"));*/
        map.get("key");
     ...
     */
    @Test
    public void testStringConcatMap_2() {
        Map<Object, Object> map = makeStringConcatMap();
        map.put("key", "value 1");
        /*[Transform from] assertEquals("value 1", map.get("key"));*/
        map.get("key");
        map.put("key", "value 2");
        /*[Transform from] assertEquals("value 1, value 2", map.get("key"));*/
        map.get("key");
        map.put("key", "value 3");
