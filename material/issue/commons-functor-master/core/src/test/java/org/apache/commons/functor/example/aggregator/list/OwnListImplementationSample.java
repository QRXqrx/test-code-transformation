...
public class OwnListImplementationSample {
    ...
    @Test
    public void sampleCreateOwnList_1() {
        CustomListAggregator<Integer> agg = new CustomListAggregator<Integer>(new IntegerSumAggregatorFunction());
        /*[Transform from] assertNull(agg.evaluate());*/
        agg.evaluate();
        agg.add(2);
        agg.add(3);
    ...
    @Test
    public void sampleCreateOwnList_2() {
        CustomListAggregator<Integer> agg = new CustomListAggregator<Integer>(new IntegerSumAggregatorFunction());
        /*[Transform from] assertNull(agg.evaluate());*/
        agg.evaluate();
        agg.add(2);
        agg.add(3);
        int eval = agg.evaluate();
        /*[Transform from] assertEquals(eval, 5);[NONE Params]*/
        ;
        // 2 items added
