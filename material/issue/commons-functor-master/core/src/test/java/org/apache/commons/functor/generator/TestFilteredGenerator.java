...
public class TestFilteredGenerator {
    ...
    public void testEquals_1() {
        Generator<Integer> anotherGenerate = new FilteredGenerator<Integer>(IteratorToGeneratorAdapter.adapt(new IntegerRange(1, 10)), isEven);
        /*[Transform from] assertEquals(filteredGenerator, filteredGenerator);[NONE Params]*/
        ;
    ...
    public void testEquals_2() {
        ...
        /*[Transform from] assertEquals(filteredGenerator, filteredGenerator);[NONE Params]*/
        ;
        /*[Transform from] assertEquals(filteredGenerator, anotherGenerate);[NONE Params]*/
        ;
    ...
    public void testEquals_3() {
        ...
        /*[Transform from] assertEquals(filteredGenerator, anotherGenerate);[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!filteredGenerator.equals((FilteredGenerator<Integer>) null));[NONE Params]*/
        ;
    ...
    public void testEquals_4() {
        ...
        /*[Transform from] assertTrue(!filteredGenerator.equals(aGenerateWithADifferentPredicate));[NONE Params]*/
        ;
    ...
    public void testHashcode_1() {
        /*[Transform from] assertEquals(filteredGenerator.hashCode(), filteredGenerator.hashCode());*/
        {
    ...
    public void testGenerate_1() {
        ...
        /*[Transform from] assertEquals(4, evenNumbers.size());*/
        evenNumbers.size();
