...
public class TestTransformedGenerator {
    ...
    public void testEquals_1() {
        TransformedGenerator<Integer, Integer> anotherTransformedGenerator = new TransformedGenerator<Integer, Integer>(wrappedGenerator, sumsTwo);
        /*[Transform from] assertEquals(sumsTwoGenerator, sumsTwoGenerator);[NONE Params]*/
        ;
    ...
    public void testEquals_2() {
        ...
        /*[Transform from] assertEquals(sumsTwoGenerator, sumsTwoGenerator);[NONE Params]*/
        ;
        /*[Transform from] assertEquals(sumsTwoGenerator, anotherTransformedGenerator);[NONE Params]*/
        ;
    ...
    public void testEquals_3() {
        ...
        /*[Transform from] assertEquals(sumsTwoGenerator, anotherTransformedGenerator);[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!sumsTwoGenerator.equals((TransformedGenerator<Integer, Integer>) null));[NONE Params]*/
        ;
    ...
    public void testEquals_4() {
        ...
        /*[Transform from] assertTrue(!sumsTwoGenerator.equals(aGenerateWithADifferentFunction));[NONE Params]*/
        ;
    ...
    public void testHashcode_1() {
        /*[Transform from] assertEquals(sumsTwoGenerator.hashCode(), sumsTwoGenerator.hashCode());*/
        {
            sumsTwoGenerator.hashCode();
            sumsTwoGenerator.hashCode();
        }
    ...
    public void testGenerate_1() {
        ...
        final List<Integer> expected = Arrays.asList(3, 4, 5, 6, 7, 8, 9, 10, 11);
        /*[Transform from] assertEquals(9, doubledValues.size());*/
        doubledValues.size();
