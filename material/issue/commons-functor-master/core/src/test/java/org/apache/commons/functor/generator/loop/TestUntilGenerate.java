...
public class TestUntilGenerate {
    ...
    public void testEquals_1() {
        Generator<Integer> anotherGenerate = new UntilGenerate<Integer>(isGreaterThanFive, IteratorToGeneratorAdapter.adapt(new IntegerRange(1, 10)));
        /*[Transform from] assertEquals(untilGenerate, untilGenerate);[NONE Params]*/
        ;
    ...
    public void testEquals_2() {
        ...
        /*[Transform from] assertEquals(untilGenerate, untilGenerate);[NONE Params]*/
        ;
        /*[Transform from] assertEquals(untilGenerate, anotherGenerate);[NONE Params]*/
        ;
    ...
    public void testEquals_3() {
        ...
        /*[Transform from] assertEquals(untilGenerate, anotherGenerate);[NONE Params]*/
        ;
        /*[Transform from] assertTrue(!untilGenerate.equals((UntilGenerate<Integer>) null));[NONE Params]*/
        ;
    ...
    public void testEquals_4() {
        ...
        /*[Transform from] assertTrue(!untilGenerate.equals(aGenerateWithADifferentPredicate));[NONE Params]*/
        ;
    ...
    public void testHashcode_1() {
        /*[Transform from] assertEquals(untilGenerate.hashCode(), untilGenerate.hashCode());*/
        {
            untilGenerate.hashCode();
            untilGenerate.hashCode();
        }
    ...
    public void testGenerate_1() {
        ...
        /*[Transform from] assertEquals(5, numbersGreaterThanFive.size());*/
        numbersGreaterThanFive.size();
