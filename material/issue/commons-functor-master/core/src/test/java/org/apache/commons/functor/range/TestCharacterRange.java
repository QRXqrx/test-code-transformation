...
public class TestCharacterRange extends BaseFunctorTest {
    ...
    public void testBoundaries_1() {
        CharacterRange range = Ranges.characterRange('b', 'l');
        /*[Transform from] assertEquals(new Endpoint<Comparable<?>>('b', BoundType.CLOSED), range.getLeftEndpoint());*/
    ...
    public void testDefaultStep_1() {
        /*[Transform from] assertEquals("Invalid default step", Integer.valueOf(-1), CharacterRange.DEFAULT_STEP.evaluate('c', 'a'));*/
        {
            Integer.valueOf(-1);
