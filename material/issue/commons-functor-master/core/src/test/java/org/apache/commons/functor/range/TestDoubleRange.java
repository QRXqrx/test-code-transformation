...
public class TestDoubleRange extends BaseFunctorTest {
    ...
    public void testBoundaries_1() {
        DoubleRange range = Ranges.doubleRange(0.0d, 10.0d);
        /*[Transform from] assertEquals(new Endpoint<Comparable<?>>(0.0d, BoundType.CLOSED), range.getLeftEndpoint());*/
    ...
    public void testDefaultStep_1() {
        /*[Transform from] assertEquals("Invalid default step", Double.valueOf(-1.0d), DoubleRange.DEFAULT_STEP.evaluate(10.0d, 1.0d));*/
        {
            Double.valueOf(-1.0d);
