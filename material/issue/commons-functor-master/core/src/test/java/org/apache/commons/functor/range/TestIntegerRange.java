...
public class TestIntegerRange extends BaseFunctorTest {
    ...
    public void testBoundaries_1() {
        IntegerRange range = Ranges.integerRange(0, 10);
        /*[Transform from] assertEquals(new Endpoint<Comparable<?>>(0, BoundType.CLOSED), range.getLeftEndpoint());*/
    ...
    public void testDefaultStep_1() {
        /*[Transform from] assertEquals("Invalid default step", Integer.valueOf(-1), IntegerRange.DEFAULT_STEP.evaluate(10, 1));*/
        {
            Integer.valueOf(-1);
