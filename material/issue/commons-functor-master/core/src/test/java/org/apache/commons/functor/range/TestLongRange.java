...
public class TestLongRange extends BaseFunctorTest {
    ...
    public void testBoundaries_1() {
        LongRange range = Ranges.longRange(0L, 10L);
        /*[Transform from] assertEquals(new Endpoint<Comparable<?>>(0L, BoundType.CLOSED), range.getLeftEndpoint());*/
    ...
    public void testDefaultStep_1() {
        /*[Transform from] assertEquals("Invalid default step", Long.valueOf(-1L), LongRange.DEFAULT_STEP.evaluate(10L, 1L));*/
        {
            Long.valueOf(-1L);
