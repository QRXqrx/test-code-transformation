...
public class DoublePercentileAggregatorFunction implements Function<List<Double>, Double> {
    ...
    public static class __CLR4_4_1z1z1kcq4stae {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 1293, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    public DoublePercentileAggregatorFunction(double percentile) {
        ...
        __CLR4_4_1z1z1kcq4stae.R.inc(1262);
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1261);
        } finally {
            __CLR4_4_1z1z1kcq4stae.R.flushNeeded();
        }
    }
    ...
    public DoublePercentileAggregatorFunction(double percentile, boolean useCopy) {
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1263);
            __CLR4_4_1z1z1kcq4stae.R.inc(1264);
            if ((((percentile < 0.0 || percentile > MAX_PERCENTAGE) && (__CLR4_4_1z1z1kcq4stae.R.iget(1265) != 0 | true)) || (__CLR4_4_1z1z1kcq4stae.R.iget(1266) == 0 & false))) {
                {
                    __CLR4_4_1z1z1kcq4stae.R.inc(1267);
                    throw new IllegalArgumentException("Invalid value for percentile: " + percentile);
                }
            }
            __CLR4_4_1z1z1kcq4stae.R.inc(1268);
            this.percentile = percentile;
            __CLR4_4_1z1z1kcq4stae.R.inc(1269);
    ...
    final int computeRank(List<Double> data) {
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1270);
            __CLR4_4_1z1z1kcq4stae.R.inc(1271);
            int maxRank = data.size() - 1;
            __CLR4_4_1z1z1kcq4stae.R.inc(1272);
            int rank = (int) Math.floor((percentile * maxRank) / MAX_PERCENTAGE);
            __CLR4_4_1z1z1kcq4stae.R.inc(1273);
            return rank;
        } finally {
            __CLR4_4_1z1z1kcq4stae.R.flushNeeded();
        }
    ...
    public Double evaluate(List<Double> data) {
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1274);
            __CLR4_4_1z1z1kcq4stae.R.inc(1275);
            if ((((data == null || data.size() == 0) && (__CLR4_4_1z1z1kcq4stae.R.iget(1276) != 0 | true)) || (__CLR4_4_1z1z1kcq4stae.R.iget(1277) == 0 & false))) {
                {
                    __CLR4_4_1z1z1kcq4stae.R.inc(1278);
                    return null;
                }
            }
            __CLR4_4_1z1z1kcq4stae.R.inc(1279);
            List<Double> copy = data;
            __CLR4_4_1z1z1kcq4stae.R.inc(1280);
            if ((((useCopy) && (__CLR4_4_1z1z1kcq4stae.R.iget(1281) != 0 | true)) || (__CLR4_4_1z1z1kcq4stae.R.iget(1282) == 0 & false))) {
                {
                    __CLR4_4_1z1z1kcq4stae.R.inc(1283);
                    copy = new ArrayList<Double>(data);
                }
            }
            __CLR4_4_1z1z1kcq4stae.R.inc(1284);
            Collections.sort(copy);
            __CLR4_4_1z1z1kcq4stae.R.inc(1285);
            int rank = computeRank(data);
            __CLR4_4_1z1z1kcq4stae.R.inc(1286);
    ...
    public double getPercentile() {
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1287);
            __CLR4_4_1z1z1kcq4stae.R.inc(1288);
            return percentile;
        } finally {
            __CLR4_4_1z1z1kcq4stae.R.flushNeeded();
        }
    ...
    public boolean isUseCopy() {
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1289);
            __CLR4_4_1z1z1kcq4stae.R.inc(1290);
            return useCopy;
        } finally {
            __CLR4_4_1z1z1kcq4stae.R.flushNeeded();
        }
    ...
    public String toString() {
        try {
            __CLR4_4_1z1z1kcq4stae.R.inc(1291);
            __CLR4_4_1z1z1kcq4stae.R.inc(1292);
