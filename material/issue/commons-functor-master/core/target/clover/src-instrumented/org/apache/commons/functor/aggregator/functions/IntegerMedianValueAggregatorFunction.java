...
public final class IntegerMedianValueAggregatorFunction implements Function<List<Integer>, Integer> {
    ...
    public static class __CLR4_4_1123123kcq4stbf {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 1401, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    public IntegerMedianValueAggregatorFunction() {
        this(true);
        __CLR4_4_1123123kcq4stbf.R.inc(1372);
        try {
            __CLR4_4_1123123kcq4stbf.R.inc(1371);
        } finally {
            __CLR4_4_1123123kcq4stbf.R.flushNeeded();
        }
    }
    ...
    public IntegerMedianValueAggregatorFunction(boolean useCopy) {
        try {
            __CLR4_4_1123123kcq4stbf.R.inc(1373);
            __CLR4_4_1123123kcq4stbf.R.inc(1374);
    ...
    public boolean isUseCopy() {
        try {
            __CLR4_4_1123123kcq4stbf.R.inc(1375);
            __CLR4_4_1123123kcq4stbf.R.inc(1376);
            return useCopy;
        } finally {
            __CLR4_4_1123123kcq4stbf.R.flushNeeded();
        }
    ...
    public Integer evaluate(List<Integer> data) {
        try {
            __CLR4_4_1123123kcq4stbf.R.inc(1377);
            __CLR4_4_1123123kcq4stbf.R.inc(1378);
            if ((((data == null || data.size() == 0) && (__CLR4_4_1123123kcq4stbf.R.iget(1379) != 0 | true)) || (__CLR4_4_1123123kcq4stbf.R.iget(1380) == 0 & false))) {
                {
                    __CLR4_4_1123123kcq4stbf.R.inc(1381);
                    return null;
                }
            // if only one element in it, it is the mean
            }
            __CLR4_4_1123123kcq4stbf.R.inc(1382);
            if ((((data.size() == 1) && (__CLR4_4_1123123kcq4stbf.R.iget(1383) != 0 | true)) || (__CLR4_4_1123123kcq4stbf.R.iget(1384) == 0 & false))) {
                {
                    __CLR4_4_1123123kcq4stbf.R.inc(1385);
                    return data.get(0);
                }
            }
            __CLR4_4_1123123kcq4stbf.R.inc(1386);
            List<Integer> copy = data;
            __CLR4_4_1123123kcq4stbf.R.inc(1387);
            if ((((useCopy) && (__CLR4_4_1123123kcq4stbf.R.iget(1388) != 0 | true)) || (__CLR4_4_1123123kcq4stbf.R.iget(1389) == 0 & false))) {
                {
                    __CLR4_4_1123123kcq4stbf.R.inc(1390);
                    copy = new ArrayList<Integer>(data);
                }
            }
            __CLR4_4_1123123kcq4stbf.R.inc(1391);
            Collections.sort(copy);
            __CLR4_4_1123123kcq4stbf.R.inc(1392);
            int n = copy.size();
            __CLR4_4_1123123kcq4stbf.R.inc(1393);
            int middle = n / 2;
            __CLR4_4_1123123kcq4stbf.R.inc(1394);
            if ((((n % 2 == 0) && (__CLR4_4_1123123kcq4stbf.R.iget(1395) != 0 | true)) || (__CLR4_4_1123123kcq4stbf.R.iget(1396) == 0 & false))) {
                {
                    // need to compute the mean of middle and middle-1 (zero based
                    // index!)
                    __CLR4_4_1123123kcq4stbf.R.inc(1397);
                    return (copy.get(middle) + copy.get(middle - 1)) / 2;
                }
            // we're already positioned on the element in the middle so just return
            // it
            }
            __CLR4_4_1123123kcq4stbf.R.inc(1398);
    ...
    public String toString() {
        try {
            __CLR4_4_1123123kcq4stbf.R.inc(1399);
            __CLR4_4_1123123kcq4stbf.R.inc(1400);
