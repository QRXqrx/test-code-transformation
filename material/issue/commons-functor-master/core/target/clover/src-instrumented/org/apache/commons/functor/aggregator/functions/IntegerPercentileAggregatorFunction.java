...
public class IntegerPercentileAggregatorFunction implements Function<List<Integer>, Integer> {
    ...
    public static class __CLR4_4_112x12xkcq4stbp {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 1433, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    public IntegerPercentileAggregatorFunction(double percentile) {
        ...
        __CLR4_4_112x12xkcq4stbp.R.inc(1402);
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1401);
        } finally {
            __CLR4_4_112x12xkcq4stbp.R.flushNeeded();
        }
    }
    ...
    public IntegerPercentileAggregatorFunction(double percentile, boolean useCopy) {
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1403);
            __CLR4_4_112x12xkcq4stbp.R.inc(1404);
            if ((((percentile < 0.0 || percentile > MAX_PERCENTAGE) && (__CLR4_4_112x12xkcq4stbp.R.iget(1405) != 0 | true)) || (__CLR4_4_112x12xkcq4stbp.R.iget(1406) == 0 & false))) {
                {
                    __CLR4_4_112x12xkcq4stbp.R.inc(1407);
                    throw new IllegalArgumentException("Invalid value for percentile: " + percentile);
                }
            }
            __CLR4_4_112x12xkcq4stbp.R.inc(1408);
            this.percentile = percentile;
            __CLR4_4_112x12xkcq4stbp.R.inc(1409);
    ...
    final int computeRank(List<Integer> data) {
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1410);
            __CLR4_4_112x12xkcq4stbp.R.inc(1411);
            int maxRank = data.size() - 1;
            __CLR4_4_112x12xkcq4stbp.R.inc(1412);
            int rank = (int) Math.floor((percentile * maxRank) / MAX_PERCENTAGE);
            __CLR4_4_112x12xkcq4stbp.R.inc(1413);
            return rank;
        } finally {
            __CLR4_4_112x12xkcq4stbp.R.flushNeeded();
        }
    ...
    public Integer evaluate(List<Integer> data) {
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1414);
            __CLR4_4_112x12xkcq4stbp.R.inc(1415);
            if ((((data == null || data.size() == 0) && (__CLR4_4_112x12xkcq4stbp.R.iget(1416) != 0 | true)) || (__CLR4_4_112x12xkcq4stbp.R.iget(1417) == 0 & false))) {
                {
                    __CLR4_4_112x12xkcq4stbp.R.inc(1418);
                    return null;
                }
            }
            __CLR4_4_112x12xkcq4stbp.R.inc(1419);
            List<Integer> copy = data;
            __CLR4_4_112x12xkcq4stbp.R.inc(1420);
            if ((((useCopy) && (__CLR4_4_112x12xkcq4stbp.R.iget(1421) != 0 | true)) || (__CLR4_4_112x12xkcq4stbp.R.iget(1422) == 0 & false))) {
                {
                    __CLR4_4_112x12xkcq4stbp.R.inc(1423);
                    copy = new ArrayList<Integer>(data);
                }
            }
            __CLR4_4_112x12xkcq4stbp.R.inc(1424);
            Collections.sort(copy);
            __CLR4_4_112x12xkcq4stbp.R.inc(1425);
            int rank = computeRank(data);
            __CLR4_4_112x12xkcq4stbp.R.inc(1426);
    ...
    public double getPercentile() {
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1427);
            __CLR4_4_112x12xkcq4stbp.R.inc(1428);
            return percentile;
        } finally {
            __CLR4_4_112x12xkcq4stbp.R.flushNeeded();
        }
    ...
    public boolean isUseCopy() {
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1429);
            __CLR4_4_112x12xkcq4stbp.R.inc(1430);
            return useCopy;
        } finally {
            __CLR4_4_112x12xkcq4stbp.R.flushNeeded();
        }
    ...
    public String toString() {
        try {
            __CLR4_4_112x12xkcq4stbp.R.inc(1431);
            __CLR4_4_112x12xkcq4stbp.R.inc(1432);
