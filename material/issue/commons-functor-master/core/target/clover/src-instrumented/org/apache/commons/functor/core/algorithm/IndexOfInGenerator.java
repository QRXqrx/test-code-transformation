 ...
 */
public final class IndexOfInGenerator<T> implements BinaryFunction<LoopGenerator<? extends T>, Predicate<? super T>, Number> {

    public static class __CLR4_4_11gp1gpkcq4stgk {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 1919, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    private static class IndexProcedure<T> implements Procedure<T> {
        ...
        IndexProcedure(LoopGenerator<? extends T> generator, Predicate<? super T> pred) {
            try {
                __CLR4_4_11gp1gpkcq4stgk.R.inc(1897);
                __CLR4_4_11gp1gpkcq4stgk.R.inc(1898);
                this.generator = generator;
                __CLR4_4_11gp1gpkcq4stgk.R.inc(1899);
                this.pred = pred;
            } finally {
                __CLR4_4_11gp1gpkcq4stgk.R.flushNeeded();
            }
        }
        ...
        public void run(T obj) {
            try {
                __CLR4_4_11gp1gpkcq4stgk.R.inc(1900);
                __CLR4_4_11gp1gpkcq4stgk.R.inc(1901);
                if ((((index < 0 && pred.test(obj)) && (__CLR4_4_11gp1gpkcq4stgk.R.iget(1902) != 0 | true)) || (__CLR4_4_11gp1gpkcq4stgk.R.iget(1903) == 0 & false))) {
                    {
                        __CLR4_4_11gp1gpkcq4stgk.R.inc(1904);
                        index = current;
                        __CLR4_4_11gp1gpkcq4stgk.R.inc(1905);
                        generator.stop();
                    }
                }
                __CLR4_4_11gp1gpkcq4stgk.R.inc(1906);
                current++;
            } finally {
                __CLR4_4_11gp1gpkcq4stgk.R.flushNeeded();
            }
    ...
    public Number evaluate(LoopGenerator<? extends T> left, Predicate<? super T> right) {
        try {
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1907);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1908);
            IndexProcedure<T> findProcedure = new IndexProcedure<T>(left, right);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1909);
            left.run(findProcedure);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1910);
    ...
    public boolean equals(Object obj) {
        try {
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1911);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1912);
    ...
    public int hashCode() {
        try {
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1913);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1914);
    ...
    public String toString() {
        try {
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1915);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1916);
    ...
    public static IndexOfInGenerator<Object> instance() {
        try {
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1917);
            __CLR4_4_11gp1gpkcq4stgk.R.inc(1918);
            return INSTANCE;
        } finally {
            __CLR4_4_11gp1gpkcq4stgk.R.flushNeeded();
        }
