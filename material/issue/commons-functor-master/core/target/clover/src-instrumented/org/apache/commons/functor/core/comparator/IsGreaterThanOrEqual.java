...
public final class IsGreaterThanOrEqual<T> implements BinaryPredicate<T, T> {
    ...
    public static class __CLR4_4_11up1upkcq4stky {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 2428, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
     ...
     */
    public static final IsGreaterThanOrEqual<Comparable<?>> INSTANCE = IsGreaterThanOrEqual.<Comparable<?>>instance();
    ...
    public IsGreaterThanOrEqual() {
        ...
        __CLR4_4_11up1upkcq4stky.R.inc(2402);
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2401);
        } finally {
            __CLR4_4_11up1upkcq4stky.R.flushNeeded();
        }
    }
    ...
    public IsGreaterThanOrEqual(Comparator<? super T> comparator) {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2403);
            __CLR4_4_11up1upkcq4stky.R.inc(2404);
    ...
    public boolean test(T left, T right) {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2405);
            __CLR4_4_11up1upkcq4stky.R.inc(2406);
    ...
    public boolean equals(Object obj) {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2407);
            __CLR4_4_11up1upkcq4stky.R.inc(2408);
            if ((((obj == this) && (__CLR4_4_11up1upkcq4stky.R.iget(2409) != 0 | true)) || (__CLR4_4_11up1upkcq4stky.R.iget(2410) == 0 & false))) {
                {
                    __CLR4_4_11up1upkcq4stky.R.inc(2411);
                    return true;
                }
            }
            __CLR4_4_11up1upkcq4stky.R.inc(2412);
            if ((((!(obj instanceof IsGreaterThanOrEqual<?>)) && (__CLR4_4_11up1upkcq4stky.R.iget(2413) != 0 | true)) || (__CLR4_4_11up1upkcq4stky.R.iget(2414) == 0 & false))) {
                {
                    __CLR4_4_11up1upkcq4stky.R.inc(2415);
                    return false;
                }
            }
            __CLR4_4_11up1upkcq4stky.R.inc(2416);
            IsGreaterThanOrEqual<?> that = (IsGreaterThanOrEqual<?>) obj;
            __CLR4_4_11up1upkcq4stky.R.inc(2417);
    ...
    public int hashCode() {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2418);
            __CLR4_4_11up1upkcq4stky.R.inc(2419);
            int hash = "IsGreaterThanOrEqual".hashCode();
            // by construction, comparator is never null
            __CLR4_4_11up1upkcq4stky.R.inc(2420);
            hash ^= comparator.hashCode();
            __CLR4_4_11up1upkcq4stky.R.inc(2421);
            return hash;
        } finally {
            __CLR4_4_11up1upkcq4stky.R.flushNeeded();
        }
    ...
    public String toString() {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2422);
            __CLR4_4_11up1upkcq4stky.R.inc(2423);
    ...
    public static <T extends Comparable<?>> IsGreaterThanOrEqual<T> instance() {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2424);
            __CLR4_4_11up1upkcq4stky.R.inc(2425);
    ...
    public static <T extends Comparable<?>> Predicate<T> instance(T right) {
        try {
            __CLR4_4_11up1upkcq4stky.R.inc(2426);
            __CLR4_4_11up1upkcq4stky.R.inc(2427);
