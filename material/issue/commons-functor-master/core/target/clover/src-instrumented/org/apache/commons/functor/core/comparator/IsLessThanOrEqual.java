...
public final class IsLessThanOrEqual<T> implements BinaryPredicate<T, T> {
    ...
    public static class __CLR4_4_11w71w7kcq4stle {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 2482, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    public IsLessThanOrEqual() {
        ...
        __CLR4_4_11w71w7kcq4stle.R.inc(2456);
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2455);
        } finally {
            __CLR4_4_11w71w7kcq4stle.R.flushNeeded();
        }
    }
    ...
    public IsLessThanOrEqual(Comparator<? super T> comparator) {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2457);
            __CLR4_4_11w71w7kcq4stle.R.inc(2458);
    ...
    public boolean test(T left, T right) {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2459);
            __CLR4_4_11w71w7kcq4stle.R.inc(2460);
    ...
    public boolean equals(Object obj) {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2461);
            __CLR4_4_11w71w7kcq4stle.R.inc(2462);
            if ((((obj == this) && (__CLR4_4_11w71w7kcq4stle.R.iget(2463) != 0 | true)) || (__CLR4_4_11w71w7kcq4stle.R.iget(2464) == 0 & false))) {
                {
                    __CLR4_4_11w71w7kcq4stle.R.inc(2465);
                    return true;
                }
            }
            __CLR4_4_11w71w7kcq4stle.R.inc(2466);
            if ((((!(obj instanceof IsLessThanOrEqual<?>)) && (__CLR4_4_11w71w7kcq4stle.R.iget(2467) != 0 | true)) || (__CLR4_4_11w71w7kcq4stle.R.iget(2468) == 0 & false))) {
                {
                    __CLR4_4_11w71w7kcq4stle.R.inc(2469);
                    return false;
                }
            }
            __CLR4_4_11w71w7kcq4stle.R.inc(2470);
            IsLessThanOrEqual<?> that = (IsLessThanOrEqual<?>) obj;
            __CLR4_4_11w71w7kcq4stle.R.inc(2471);
    ...
    public int hashCode() {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2472);
            __CLR4_4_11w71w7kcq4stle.R.inc(2473);
            int hash = "IsLessThanOrEqual".hashCode();
            // by construction, comparator is never null
            __CLR4_4_11w71w7kcq4stle.R.inc(2474);
            hash ^= comparator.hashCode();
            __CLR4_4_11w71w7kcq4stle.R.inc(2475);
            return hash;
        } finally {
            __CLR4_4_11w71w7kcq4stle.R.flushNeeded();
        }
    ...
    public String toString() {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2476);
            __CLR4_4_11w71w7kcq4stle.R.inc(2477);
    ...
    public static <T extends Comparable<?>> IsLessThanOrEqual<T> instance() {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2478);
            __CLR4_4_11w71w7kcq4stle.R.inc(2479);
    ...
    public static <T extends Comparable<?>> Predicate<T> instance(T right) {
        try {
            __CLR4_4_11w71w7kcq4stle.R.inc(2480);
            __CLR4_4_11w71w7kcq4stle.R.inc(2481);
