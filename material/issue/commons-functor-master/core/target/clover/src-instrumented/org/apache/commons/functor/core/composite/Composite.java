...
public final class Composite {
    ...
    public static class __CLR4_4_128f28fkcq4stoq {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 2914, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    private Composite() {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2895);
        } finally {
            __CLR4_4_128f28fkcq4stoq.R.flushNeeded();
        }
    }
    ...
    public static <A> CompositeProcedure<A> procedure(Procedure<? super A> procedure) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2896);
            __CLR4_4_128f28fkcq4stoq.R.inc(2897);
    ...
    public static <A, T> CompositeProcedure<A> procedure(Procedure<? super T> procedure, Function<? super A, ? extends T> function) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2898);
            __CLR4_4_128f28fkcq4stoq.R.inc(2899);
    ...
    public static <A> CompositePredicate<A> predicate(Predicate<? super A> pred) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2900);
            __CLR4_4_128f28fkcq4stoq.R.inc(2901);
    ...
    public static <A, T> CompositePredicate<A> predicate(Predicate<? super T> predicate, Function<? super A, ? extends T> function) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2902);
            __CLR4_4_128f28fkcq4stoq.R.inc(2903);
    ...
    public static <L, R, G, H> CompositeBinaryPredicate<L, R> predicate(BinaryPredicate<? super G, ? super H> p, Function<? super L, ? extends G> g, Function<? super R, ? extends H> h) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2904);
            __CLR4_4_128f28fkcq4stoq.R.inc(2905);
    ...
    public static <A, T> CompositeFunction<A, T> function(Function<? super A, ? extends T> f) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2906);
            __CLR4_4_128f28fkcq4stoq.R.inc(2907);
    ...
    public static <A, X, T> CompositeFunction<A, T> function(Function<? super X, ? extends T> f, Function<? super A, ? extends X> g) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2908);
            __CLR4_4_128f28fkcq4stoq.R.inc(2909);
     ...
     */
    public static <L, R, G, H, T> CompositeBinaryFunction<L, R, T> function(BinaryFunction<? super G, ? super H, ? extends T> f, Function<? super L, ? extends G> g, Function<? super R, ? extends H> h) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2910);
            __CLR4_4_128f28fkcq4stoq.R.inc(2911);
    ...
    public static <L, R, G, H, T> BinaryCompositeBinaryFunction<L, R, T> function(BinaryFunction<? super G, ? super H, ? extends T> f, BinaryFunction<? super L, ? super R, ? extends G> g, BinaryFunction<? super L, ? super R, ? extends H> h) {
        try {
            __CLR4_4_128f28fkcq4stoq.R.inc(2912);
            __CLR4_4_128f28fkcq4stoq.R.inc(2913);
