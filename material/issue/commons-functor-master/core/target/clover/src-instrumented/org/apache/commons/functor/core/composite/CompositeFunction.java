...
public class CompositeFunction<A, T> implements Function<A, T> {
    ...
    public static class __CLR4_4_12aq2aqkcq4stpm {
        ...
        static {
            ...
            try {
                ...
                _R = com_atlassian_clover.Clover.getRecorder("\u002f\u0072\u006f\u006f\u0074\u002f\u0071\u0072\u0078\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0074\u0065\u0073\u0074\u002d\u0063\u006f\u0064\u0065\u002d\u0074\u0072\u0061\u006e\u0073\u0066\u006f\u0072\u006d\u0061\u0074\u0069\u006f\u006e\u002f\u0065\u0078\u0070\u0065\u0072\u0069\u006d\u0065\u006e\u0074\u002f\u0037\u002f\u006f\u0072\u0069\u0067\u0069\u006e\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0066\u0075\u006e\u0063\u0074\u006f\u0072\u002d\u006d\u0061\u0073\u0074\u0065\u0072\u002f\u0063\u006f\u0072\u0065\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062", 1594984852842L, 8589935092L, 3020, profiles, new java.lang.String[] { "clover.distributed.coverage", null });
    ...
    private static class Helper<X, A, T> implements Function<A, T> {
         ...
         */
        public Helper(Function<? super X, ? extends T> following, Function<? super A, ? extends X> preceding) {
            try {
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2978);
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2979);
                this.following = Validate.notNull(following, "Function argument must not be null");
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2980);
                this.preceding = Validate.notNull(preceding, "Function argument must not be null");
            } finally {
                __CLR4_4_12aq2aqkcq4stpm.R.flushNeeded();
            }
        }
        ...
        public T evaluate(A obj) {
            try {
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2981);
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2982);
        ...
        public boolean equals(Object obj) {
            try {
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2983);
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2984);
        ...
        private boolean equals(Helper<?, ?, ?> helper) {
            try {
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2985);
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2986);
        ...
        public int hashCode() {
            try {
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2987);
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2988);
                int result = "CompositeFunction$Helper".hashCode();
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2989);
                result <<= 2;
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2990);
                result ^= following.hashCode();
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2991);
                result <<= 2;
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2992);
                result ^= preceding.hashCode();
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2993);
                return result;
            } finally {
                __CLR4_4_12aq2aqkcq4stpm.R.flushNeeded();
            }
        ...
        public String toString() {
            try {
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2994);
                __CLR4_4_12aq2aqkcq4stpm.R.inc(2995);
    ...
    public CompositeFunction(Function<? super A, ? extends T> function) {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(2996);
            __CLR4_4_12aq2aqkcq4stpm.R.inc(2997);
     ...
     */
    private <X> CompositeFunction(Function<? super X, ? extends T> following, Function<? super A, ? extends X> preceding) {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(2998);
            __CLR4_4_12aq2aqkcq4stpm.R.inc(2999);
    ...
    public final T evaluate(A obj) {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3000);
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3001);
    ...
    public final <P> CompositeFunction<P, T> of(Function<? super P, ? extends A> preceding) {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3002);
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3003);
            Validate.notNull(preceding, "preceding function was null");
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3004);
    ...
    public final boolean equals(Object obj) {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3005);
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3006);
            if ((((obj == this) && (__CLR4_4_12aq2aqkcq4stpm.R.iget(3007) != 0 | true)) || (__CLR4_4_12aq2aqkcq4stpm.R.iget(3008) == 0 & false))) {
                {
                    __CLR4_4_12aq2aqkcq4stpm.R.inc(3009);
                    return true;
                }
            }
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3010);
            if ((((!(obj instanceof CompositeFunction<?, ?>)) && (__CLR4_4_12aq2aqkcq4stpm.R.iget(3011) != 0 | true)) || (__CLR4_4_12aq2aqkcq4stpm.R.iget(3012) == 0 & false))) {
                {
                    __CLR4_4_12aq2aqkcq4stpm.R.inc(3013);
                    return false;
                }
            }
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3014);
            CompositeFunction<?, ?> that = (CompositeFunction<?, ?>) obj;
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3015);
    ...
    public int hashCode() {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3016);
            // by construction, list is never null
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3017);
    ...
    public String toString() {
        try {
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3018);
            __CLR4_4_12aq2aqkcq4stpm.R.inc(3019);
